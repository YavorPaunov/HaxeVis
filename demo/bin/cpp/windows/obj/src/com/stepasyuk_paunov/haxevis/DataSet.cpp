...
Array< ::com::stepasyuk_paunov::haxevis::DataSetEntry > DataSet_obj::get_entries( ){
	HX_STACK_PUSH("DataSet::get_entries","com/stepasyuk_paunov/haxevis/DataSet.hx",41);
	HX_STACK_THIS(this);
	HX_STACK_LINE(41)
...
Array< Float > DataSet_obj::getRatios( ){
	HX_STACK_PUSH("DataSet::getRatios","com/stepasyuk_paunov/haxevis/DataSet.hx",30);
	HX_STACK_THIS(this);
	HX_STACK_LINE(31)
...
Float DataSet_obj::getSum( ){
	HX_STACK_PUSH("DataSet::getSum","com/stepasyuk_paunov/haxevis/DataSet.hx",21);
	HX_STACK_THIS(this);
	HX_STACK_LINE(22)
