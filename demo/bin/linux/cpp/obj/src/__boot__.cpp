...
::com::stepasyuk_paunov::haxevis::PieChart_obj::__register();
::com::stepasyuk_paunov::haxevis::LineChartDataSetEntry_obj::__register();
::com::stepasyuk_paunov::haxevis::LineChart_obj::__register();
::com::stepasyuk_paunov::haxevis::Legend_obj::__register();
::com::stepasyuk_paunov::haxevis::DataSetEntry_obj::__register();
::com::stepasyuk_paunov::haxevis::DataSet_obj::__register();
::com::stepasyuk_paunov::haxevis::Colors_obj::__register();
::com::stepasyuk_paunov::haxevis::BarChart_obj::__register();
::com::demo::haxevis::Main_obj::__register();
...
::com::demo::haxevis::Main_obj::__boot();
::com::stepasyuk_paunov::haxevis::BarChart_obj::__boot();
::com::stepasyuk_paunov::haxevis::Colors_obj::__boot();
::com::stepasyuk_paunov::haxevis::DataSet_obj::__boot();
::com::stepasyuk_paunov::haxevis::DataSetEntry_obj::__boot();
::com::stepasyuk_paunov::haxevis::Legend_obj::__boot();
::com::stepasyuk_paunov::haxevis::LineChart_obj::__boot();
::com::stepasyuk_paunov::haxevis::LineChartDataSetEntry_obj::__boot();
::com::stepasyuk_paunov::haxevis::PieChart_obj::__boot();
